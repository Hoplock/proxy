# 0019 — Target credential rejection: classify, contain, disclose

> New prompt, added by phase 0012. It is appended rather than inserted: nothing
> in 0013–0018 depends on it, and it depends on nothing they change. Pull it
...
`docs/learnings/0019-target-auth-failure-containment-learnings.md`. The summary
