# 0030 — Standalone FortiSwitchOS driver

> Deferred from phase 0014, and deliberately ordered **after** 0029. The estate
...
- `docs/learnings/0014-…` — the FortiGate driver, its CLI state machine, its
  ...
  name.
- `docs/learnings/0029-…` — whether the FortiLink phase left anything reusable
...
As 0029: extend the `device` node, add the route to
...
`docs/learnings/0030-standalone-fortiswitch-driver-learnings.md`, whose summary
